...
class _RawSettings(BaseSettings):
    ...
    search_backends: str = "startpage,duckduckgo,yahoo,brave"
    ...
    health_report_interval_seconds: int = 300  # 5m; push health snapshot to admin panel (0=off)
...
def from_settings(s: _RawSettings) -> Config:
    ...
    return Config(
        ...
        health_report_interval_seconds=s.health_report_interval_seconds,
