...
AUDIENCE_FORMS = (
    ...
    "особи з інвалідністю внаслідок війни", "інваліди війни",
    "родини військових", "дружини військових",
    "діти військових", "сім'ї УБД", "сім'ї загиблих Захисників", "члени сімей полеглих",
    # «прикордонники»/«ТРО» СВІДОМО вилучено як query-аудиторії — 0/≤2 host у корпусі
    # (той самий 0-unique профіль, що police/dsns). Тероборонівці/прикордонники все одно
    # покриті «військові/ЗСУ/захисники»; ТрО→warrior КЛАСИФІКАЦІЯ у lexicon.py лишається.
    # парасолькове «захисники/захисниці» — бізнес часто адресує знижки саме так
    # (корпус-support 13/6, рівень УБД). «добровольці/волонтери» СВІДОМО НЕ додано:
    # 0/1 host у корпусі — шум (перевірено виконанням).
    "захисники", "захисниці",
)
# NB: «поліцейські», «ДСНС», «Нацгвардія» СВІДОМО вилучено — 0 унікальних оферів,
# усе покрито військові/ветерани/УБД (див. lexicon.py TARGET_LEXICON коментар).
...
INTENT_FORMS = (
    ...
    "спеціальна ціна", "пільгова ціна", "спеціальні умови",
)
...
SEED_SERVICES = (
    ...
    "протезування зубів", "імплантація", "стоматологія", "окуляри", "контактні лінзи",
    ...
    # побут / краса / одяг
    "барбершоп", "салон краси", "манікюр", "хімчистка", "ремонт взуття", "одяг",
    # культура / спорт
