...
TARGET_LEXICON = [
    ...
    # Поліція/ДСНС/НГУ СВІДОМО НЕ класифікуються: пошук по них давав 0 унікальних
    # оферів (усі справжні силові офери й так тегуються warrior/ubd/veteran, бо бізнес
    # пише всі категорії гуртом), а «police-only» результати були 100% junk — фільми,
    # готелі Туреччини, телефони відділів. Прибрані і з query_grid, і з page-target токенів.
]
