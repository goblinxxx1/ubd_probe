...
TARGET_LEXICON = [
    ...
    ("Військовий", "warrior", _compile((
        ...
        # повний текст ЗСУ (відмінки через корінь "збройн…сил"): збройних сил/збройні сили
        "збройних сил", "збройні сил",
        # ТрО: абревіатура (guard, щоб не «троянда/тролейбус») + повний текст (усі відмінки)
        ("тро", r"(?!\w)"), "тероборон", "територіальн"))),
    ...
    ("НГУ", "ngu", _compile((
        # "нацгвард" — злите «нацгвардія»; "гвард" — повна «національна гвардія/гвардії…»
        # (окремим словом, усі відмінки). Разом покривають абревіатуру, злиту й повну форми.
        "нацгвард", "гвард", ("нгу", r"(?!\w)")))),
    ("Працівник ДСНС", "dsns", _compile((
        "дснс", "рятувальник", "пожежник",
        # повний текст ДСНС (стандартна форма назви — родовий): «…з надзвичайних ситуацій»
        # (не матчить маркетингове «надзвичайна знижка», бо там «надзвичайна», не «надзвичайних ситуац»)
        "надзвичайних ситуац"))),
