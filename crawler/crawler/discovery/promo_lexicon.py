...
_PAGE_TYPE_TOKENS: tuple[str, ...] = (
    ...
    # ТрО (→ warrior) + УБД. Поліція/ДСНС/НГУ СВІДОМО прибрано: 0 унікальних оферів
    # (усі покриті військові/УБД), лишалися тільки junk — фільми/готелі Туреччини/
    # телефони відділів поліції; а translit-токен "police" ще й ловив полиц-ю (shelf).
    "teroboron", "ubd",
    "теробор", "убд", "бойов",
    # контакти
    "kontakt", "contact",
...
INCLUDE_ANCHORS: tuple[str, ...] = (
    ...
    "територіальна оборона", "бойових дій",
